...
const int PlAYER_AINM_NUM = 6;
const int PLAYER_SPEED = 3;

IMAGE img_player_left[PlAYER_AINM_NUM];
IMAGE img_player_right[PlAYER_AINM_NUM];
...
void loadAnimation()
{
	for (size_t i = 0; i < PlAYER_AINM_NUM; i++)
	{
...
int main()
{
	...
	while (running)
	{
		...
		idx_current_anim = idx_current_anim % PlAYER_AINM_NUM;
